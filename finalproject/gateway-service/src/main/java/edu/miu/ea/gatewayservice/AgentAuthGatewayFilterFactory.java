...
@Component
public class AgentAuthGatewayFilterFactory extends AbstractGatewayFilterFactory<AgentAuthGatewayFilterFactory.Config> {
    private static final Log logger = LogFactory.getLog(AgentAuthGatewayFilterFactory.class);
    ...
    public AgentAuthGatewayFilterFactory() {
        super(AgentAuthGatewayFilterFactory.Config.class);
    ...
    @Override
    public GatewayFilter apply(AgentAuthGatewayFilterFactory.Config config) {
