...
@Component
public class PassengerAuthGatewayFilterFactory extends AbstractGatewayFilterFactory<PassengerAuthGatewayFilterFactory.Config> {
    private static final Log logger = LogFactory.getLog(PassengerAuthGatewayFilterFactory.class);
    ...
    public PassengerAuthGatewayFilterFactory() {
        super(Config.class);
